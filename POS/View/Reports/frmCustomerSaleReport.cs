...
namespace POS
{
    public partial class frmCustomerSaleReport : Form
    {
        ...
        private void frmCustomerSaleReport_Load(object sender, EventArgs e)
        {
            ...
            cbovipstarted.DataSource = shoplist;
            cbovipstarted.DisplayMember = "ShopName";
            cbovipstarted.ValueMember = "ShortCode";
        ...
        private void loadData()
        {
            if (IsStart)
            {
                ...
                string selectshop = cbovipstarted.SelectedValue.ToString();
               ...
               // string currentshopname = (from p in entity.Shops where p.Id == shopid select p.ShopName).FirstOrDefault();
                ...
                resultlist = entity.GetCustomerSaleById(cId, pId, fromDate, toDate, currentshortcode, selectshop);
        ...
        private void ShowReportViewer()
        {
            ...
            string reportPath = Application.StartupPath + "\\Reports\\Customer Sale.rdlc";
        ...
        private void cbovipstarted_SelectedIndexChanged(object sender, EventArgs e)
        {
            loadData();
        }
