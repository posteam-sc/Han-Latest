...
namespace POS
{
    public partial class DailyTotalReport : Form
    {
        ...
        private void DailyTotalReport_Load(object sender, EventArgs e)
        {
            ...
            CounterList.AddRange((from bList in entity.Counters where bList.IsDelete==false select bList).ToList());
        ...
        private void ShowReportViewr()
        {
            ...
            string reportPath = Application.StartupPath + "\\Reports\\Daily Total Sale.rdlc";
