...
namespace POS
{
    public partial class PurchaseInput : Form
    {
        ...
        private void PurchaseDetail_Load(object sender, EventArgs e)
        {
            ...
            var _productList = (from p in entity.Products where p.IsConsignment == false && p.IsDeleted==false select p).ToList();
        ...
        private void Barcode_Input()
        {
            ...
            long productId = (from p in entity.Products where p.Barcode == _barcode && p.IsConsignment == false && p.IsDeleted==false select p.Id).FirstOrDefault();
        ...
        public void ReloadProduct()
        {
            ...
            var _product = (from a in entity.Products where a.IsConsignment == false && a.IsDeleted==false select a).ToList(); ;
