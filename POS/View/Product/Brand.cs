    ...
    public partial class Brand : Form
    {
        ...
        private void Brand_Load(object sender, EventArgs e)
        {
            ...
            if (notbackoffice)
            {
                ...
                dgvBrandList.Columns[3].Visible = false;
            }
            else
            {
                dgvBrandList.Columns[3].Visible = true;
            }
        ...
        private void Save()
        {
            ...
            if (txtName.Text.Trim() != string.Empty)
            {
                ...
                if (bObj == null)
                {
                    ...
                    else if (System.Windows.Forms.Application.OpenForms["MemberRule"] != null)
                    {
                        POSEntities entity=new POSEntities();
                        string brandname = (from p in entity.Brands where p.Id == brandId select p.Name).FirstOrDefault();
                        MemberRule newForm = (MemberRule)System.Windows.Forms.Application.OpenForms["MemberRule"];
                        newForm.Bind_BrandForPromotion(brandname);
                        newForm.Bind_BrandForReferralProgram(brandname);
                        this.Close();
                      //  newForm.SetCurrentBrand(brandId);
                    }
                    #endregion
