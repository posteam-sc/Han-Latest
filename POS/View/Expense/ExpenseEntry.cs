...
namespace POS
{
    public partial class ExpenseEntry : Form
    {
        ...
        private void ExpenseEntry_Load(object sender, EventArgs e)
        {
            ...
            {
                btnExpCag.Visible = false;
            }
            else
            {
                btnExpCag.Visible = true;
            }
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (_count < 10)
                {
                     ExpenseNumber = "EP"+SettingController.DefaultShop.ShortCode + DateTime.Now.Year.ToString() + month + DateTime.Now.Day.ToString() + ("0" + _count).ToString();
                }
                else
                {
                    ExpenseNumber = "EP" + SettingController.DefaultShop.ShortCode + DateTime.Now.Year.ToString() + month + DateTime.Now.Day.ToString() + (_count).ToString();
                }
