...
namespace POS
{
    public partial class Login : Form
    {
        ...
        private void Login_Load(object sender, EventArgs e)
        {
            ...
            counterList.AddRange((from c in entity.Counters where c.IsDelete == false select c).ToList());
            ...
            if (!hasError)
            {
                ...
                if (user != null)
                {
                    ...
                    if (p == password)
                    {
                        ...
                        if (DisabledImportExport)
                        {
                            ((MDIParent)this.ParentForm).importSAPToolStripMenuItem.Visible =
                            ((MDIParent)this.ParentForm).importByProductToolStripMenuItem.Visible =
                            ...
                            ((MDIParent)this.ParentForm).exportSAPToolStripMenuItem.Visible =
        ...
        public void SaleMDIForm()
        {
            ...
            form.IsBackDateExportSuccess = IsBackDateExportSuccess;
            form.IsAutoImportSuccess = IsAutoImportSuccess;
            // this._objFormLoadControl += new FormLoadDel(form.formLoadJobs);
        ...
        {
            // ((MDIParent)this.ParentForm).refundListToolStripMenuItem1.Visible = false;
            ...
            if (MemberShip.UserRole == "Admin")
            {
                ...
                switch (_menu)
                {
                  ...
                  ((MDIParent)this.ParentForm).createExpenseEntryToolStripMenuItem.Visible =
                        ...
                        ((MDIParent)this.ParentForm).backDateExportToolStripMenuItem.Visible = !IsBackDateExportSuccess;//!IsAllExportSuccess;
                    ...
                    case "POS":
                        ...
                        #region Setting
                        ((MDIParent)this.ParentForm).settingsToolStripMenuItem1.Enabled = true;
                        ((MDIParent)this.ParentForm).settingsToolStripMenuItem1.Visible = true;
                  ...
                  ((MDIParent)this.ParentForm).createExpenseEntryToolStripMenuItem.Visible =
                    ...
                    case "POS":
                     ...
                     ((MDIParent)this.ParentForm).addNewProductToolStripMenuItem.Visible = false;
                        ...
                        ((MDIParent)this.ParentForm).settingsToolStripMenuItem1.Enabled =
                       ((MDIParent)this.ParentForm).settingsToolStripMenuItem1.Visible =
