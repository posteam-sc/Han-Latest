    ...
    public partial class ConsignmentProductCounter : Form
    {
        ...
        private void ConsignmentProductCounter_Load(object sender, EventArgs e)
        {
            ...
            if (notbackoffice)
            {
                ...
                dgvCosignmentCounterList.Columns[6].Visible = false;
            }
            else
            {
                dgvCosignmentCounterList.Columns[6].Visible = true;
            }
            DataBind();
        }
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            if (!hasError)
            {
                ...
                if (!isEdit)
                {
                    ...
                    ConsignmentCounter consignmentCounterObj2 = (from c in entity.ConsignmentCounters where c.Name == txtName.Text && c.IsDelete==false select c).FirstOrDefault();
        ...
        private void DataBind()
        {
            ...
            dgvCosignmentCounterList.DataSource = entity.ConsignmentCounters.Where(x=>x.IsDelete==false).ToList();
        }
