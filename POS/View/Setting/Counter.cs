    ...
    public partial class Counter : Form
    {
        ...
        private void Counter_Load(object sender, EventArgs e)
        {
            ...
            if (notbackoffice)
            {
                ...
                dgvCounterList.Columns[3].Visible = false;
            }
            else
            {
                dgvCounterList.Columns[3].Visible = true;
            }
                ...
                if (txtName.Text.Trim() != string.Empty)
                {
                    ...
                    if (counter == null)
                    {
                        ...
                        if (!isEdit)
                        {
                            ...
                            {
                                dgvCounterList.DataSource = (from b in posEntity.Counters where b.IsDelete == false orderby b.Id descending select b).ToList();
