...
namespace POS.APP_Data
{
    ...
    public partial class Transaction
    {
        ...
        public Nullable<bool> IsCalculatePoint { get; set; }
        public Nullable<bool> IsExported { get; set; }
        public Nullable<decimal> CouponCodeAmount { get; set; }
        public Nullable<bool> IsLoyaltyExported { get; set; }
        public string PitiMemberId { get; set; }
        public Nullable<int> CouponCodeId { get; set; }
        public string PitiMemberName { get; set; }
